...
#define meLibSetMinimalVmeConfig() \
	{ \
		hw(0xBCC00000) = (u32Me)0xFFFFFFFFu; \
		hw(0xBCC00010) = 1; \
		while (hw(0xBCC00010)) { \
			meLibSync(); \
		}; \
		hw(0xBCC00070) = 0; \
		hw(0xBCC00020) = (u32Me)0xFFFFFFFFu; \
		hw(0xBCC00030) = 1; \
		hw(0xBCC00040) = 2; /*1*/ \
		meLibSync(); \
	}
...
#define ME_LIB_SETUP_DEFAULT_SUSPEND_HANDLER() \
	extern "C" __attribute__((noinline, aligned(4))) void \
	meLibOnExternalInterrupt(void) \
	{ \
		asm volatile( \
    ".set push                       \n" \
    ".set volatile                   \n" \
...
\
	extern "C" __attribute__((noinline, aligned(4))) void meLibOnSleep() \
	{ \
...
\
	extern "C" __attribute__((noinline, aligned(4))) void meLibOnWake() \
	{ \
