...
public:
	 ...
	 * colors.
	 *
	 * @param input Color to find complement/analogous colors of. Any colors
	 * will have the same tone, and chroma as the input color, modulo any
	 * restrictions due to the other hues having lower limits on chroma.
	 */
	 ...
	 *
	 * <p>In art, this is usually described as a set of 5 colors on a color
	 * wheel divided into 12 sections. This method allows provision of either of
	 * those values.
	 *
